/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a76f7f9179cbce47a87f31f74b47553b)
// Runtime types generated with workerd@1.20260603.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	ASSETS: Fetcher;
	BASE_URL: "https://tjaldur.9z.is";
	REFRESH_WEATHER: Workflow<Parameters<import("./src/index").RefreshWeather['run']>[0]['payload']>;
	REFRESH_CAMPSITES: Workflow<Parameters<import("./src/index").RefreshCampsites['run']>[0]['payload']>;
}
